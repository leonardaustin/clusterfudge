...
export function DiscoverPortForwards(arg1) {
  return window['go']['handlers']['StreamHandler']['DiscoverPortForwards'](arg1);
}
...
export function OnSystemWake() {
  return window['go']['handlers']['StreamHandler']['OnSystemWake']();
}
...
export function StopAllPortForwards() {
  return window['go']['handlers']['StreamHandler']['StopAllPortForwards']();
}
