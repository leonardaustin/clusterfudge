...
type AppConfig struct {
	...
	// Port Forward
	PortForwardPresets map[string]PortForwardPreset `json:"portForwardPresets"`

	// Internal
	SkipUpdateVersion string `json:"skipUpdateVersion"`
}

// PortForwardPreset stores a saved or auto-discovered port forward configuration.
type PortForwardPreset struct {
	...
	Source      string `json:"source"` // "annotation" or "manual"
}
