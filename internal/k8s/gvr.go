...
var (
	...
	GVRCSIDrivers        = schema.GroupVersionResource{Group: "storage.k8s.io", Version: "v1", Resource: "csidrivers"}
	GVRCSINodes          = schema.GroupVersionResource{Group: "storage.k8s.io", Version: "v1", Resource: "csinodes"}
	GVRVolumeAttachments = schema.GroupVersionResource{Group: "storage.k8s.io", Version: "v1", Resource: "volumeattachments"}
)

// Snapshot resources.
var (
	GVRVolumeSnapshots = schema.GroupVersionResource{Group: "snapshot.storage.k8s.io", Version: "v1", Resource: "volumesnapshots"}
)
...
// Node v1 resources.
var (
	GVRRuntimeClasses = schema.GroupVersionResource{Group: "node.k8s.io", Version: "v1", Resource: "runtimeclasses"}
)

// Flowcontrol v1 resources.
var (
	GVRFlowSchemas              = schema.GroupVersionResource{Group: "flowcontrol.apiserver.k8s.io", Version: "v1", Resource: "flowschemas"}
	GVRPriorityLevelConfigs     = schema.GroupVersionResource{Group: "flowcontrol.apiserver.k8s.io", Version: "v1", Resource: "prioritylevelconfigurations"}
)
...
func AllCoreGVRs() []schema.GroupVersionResource {
	return []schema.GroupVersionResource{
		...
		GVRHPAs, GVRPDBs,
		GVRStorageClasses, GVRCSIDrivers, GVRCSINodes, GVRVolumeAttachments,
		GVRVolumeSnapshots,
		GVRLeases,
		GVREndpointSlices,
		GVRPriorityClasses,
		GVRRuntimeClasses,
		GVRFlowSchemas, GVRPriorityLevelConfigs,
	}
}
...
func GVRDisplayName(gvr schema.GroupVersionResource) string {
	names := map[string]string{
		...
		"flowschemas":                 "Flow Schemas",
		"prioritylevelconfigurations": "Priority Level Configurations",
